...
from ..core.domain import PowerLevel
from ..utils.yaml_io import load_config, load_indices, resolve_path, sidecar_to_source, write_yaml
        ...
        for idx in indices:
            ...
            for path_str in idx.paths:
                ...
                for sidecar in search_path.rglob(".*.sidecar.yaml"):
                    ...
                    source_file = sidecar_to_source(sidecar)

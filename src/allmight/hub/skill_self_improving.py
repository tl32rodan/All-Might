"""Self-improving skill content — hub-level self-improvement loop.

This skill teaches the hub agent how to audit all workspaces' .claude/ layers,
identify patterns worth promoting to global level, detect gaps, and propose

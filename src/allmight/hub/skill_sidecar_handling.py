"""Sidecar-handling skill content — SOS-based sidecar update SOP.

This skill provides the complete standard operating procedure for updating
sidecar files through CliosoftSOS.  It is a global SOP that applies to any

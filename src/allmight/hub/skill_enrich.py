"""Enrich skill content — know-how injection into a workspace's .claude/ layer.

This skill teaches the hub agent how to persist domain knowledge into a
workspace's ``.claude/`` directory — updating the workspace's CLAUDE.md and

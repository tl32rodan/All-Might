"""Detroit-SMAK skill content — precision strike via sub-agent.

This skill teaches the hub agent how to dispatch sub-agents into specific
workspaces for semantic search, enrichment lookup, and graph queries.
The sub-agent runs with the workspace directory as cwd, which triggers

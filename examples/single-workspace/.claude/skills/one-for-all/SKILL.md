...
|-------|-------------|-------|
| `source_code` | Project source code (Python) | `./src` |
| `tests` | Unit tests, integration tests, and test cases | `./tests` |
| `documentation` | Architecture docs, API docs, and general knowledge base | `./docs` |
